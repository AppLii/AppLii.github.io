<template>
  ...
  <SectionComponent>
    <h2>加入の流れ</h2>
    <ol>
      <li>AppLiiの新歓Discordサーバーに参加する</li>
      <li>新入生歓迎会イベント(対面)に参加する</li>
      <li>加入申請フォームを送信する</li>
      <li>AppLiiへの参加確認メールを受け取り、メールの内容にしたがって加入作業を行う</li>
      <li>加入完了！</li>
    </ol>
    <p>※加入申請フォームの受付期間は5/31までです。以降は個別での対応となります。</P>
    <h2>加入条件</h2>
    <p>AppLiiへ加入するための条件を設けさせていただいております。</p>
    <ul>
      <li>1回以上の新入生歓迎会の参加</li>
      <li>学研賠（学研災付帯賠償責任保険）への加入</li>
    </ul>
    <p>※予定の関係で新入生歓迎会に参加できない場合は、個別に対応いたしますので、お問い合わせ先までご連絡ください。</p>
  </SectionComponent>
  ...
  <SectionComponent>
    ...
    <h2>これまでの実績と開発</h2>
    <li>
      <lu>「大学食堂混雑アプリ どうこむ」</lu>
      <lu>ミーティングルーム予約システム</lu>
    </li>
    ...
    <p>去年から3回生7名で開発を進めて、この春にリリースしました。私達クリエの学生がプロジェクト活動に使用する会議室を、Webから予約できるアプリです。クリエの事務員の方々も使用するアプリなので、話し合いを重ねて学生にとっても事務員の方々にとっても使いやすい機能などをもりこんでいます。</p>
    <p>このアプリを開発する活動も<a href="https://www.wakayama-u.ac.jp/crea/crea-project/project/2025_mission.html">2025年度のクリエミッション</a>として実施していました。</p>
  </SectionComponent>
  ...
  <SectionComponent>
    ...
    <ul>
      <li> アプリ開発（週1～2・それぞれのチームごとに決定） </li>
      <li> 会議（1ヶ月ごと・日程は直前にアンケートで決定） </li>
      <li> 技術交流会（不定期）</li>
    </ul>
    <p>しかし、必ず参加しないといけない活動はありません。興味のある活動に参加することができます。</p>
    <p>クリエミッションや自主演習を利用する方は、発表会や申請締切の直前にもう少し忙しくなります。</p>
    <h2>年間活動スケジュール</h2>
    <p>クリエミッションや自主演習、大学外のコンテストなど、さまざまなイベントに合わせて活動を行っています。こちらも定期的な活動と同じように、必ず参加しないといけない活動はありません。皆さんの興味や目標に合わせて活動することができます。</p>
  </SectionComponent>
  ...
  <SectionComponent>
    ...
    <p>また、迷惑メールボックスなどもあわせてご確認いただきますようお願い申し上げます。</p>
  </SectionComponent>
</template>
