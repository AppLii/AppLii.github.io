<template>
    ...
    <SectionComponent>
        <h1>2026年度の新歓ページ</h1>
        <p>2026年度の新入生歓迎会の詳細は、2026年4月頃に公開予定です。</p>
        <p>しばらくお待ちください。</p>
    </SectionComponent>
    ...
    <SectionComponent style="background-color: rgb(255, 255, 228);">
        ...
        <p></p>
        <p> <a class="discord-link" href="#" target="_blank">AppLii新歓Discordサーバーに参加する（準備中）</a>
        </p>
        <ul>
    ...
    <SectionComponent>
        ...
        <p>※加入申請フォームの受付期間は5/31までを予定しています。以降は個別での対応となります。</P>
        <h2>加入条件</h2>
