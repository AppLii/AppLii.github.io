<template>
  ...
  <h3>私たちが扱うデータ</h3>
  <p>
    私たちは、食堂内に設置したIoTデバイスを用いてBluetoothの識別情報を取得しています。具体的には「Bluetoothアドレス」やそれに付随する端末情報（デバイス名・製造企業など）を取得しています。これらのデータから食堂内の電子デバイスを計測し、滞在人数を推定しています。
  </p>
  ...
  <p>
    そして、Bluetoothアドレスは端末によって自動的に更新される仕組みとなっています。たとえば、iPhoneやiPadには「Bluetoothデバイスのアドレスを頻繁に変更することで一定期間内にBLEデバイスが追跡される可能性を低減する機能」が備えられていることが明記されています。（<a
      href="https://support.apple.com/ja-jp/guide/security/sec82597d97e/web"
      >Apple社より</a
    >）このような機能により、Bluetoothアドレスを用いた個人の特定・追跡はより難しくなっています。
  </p>
